...
with open("output1\\resultMNB2.csv") as myfile:
...
fpos=0
fneg=0
with open("output1\\resultBNB2.csv") as myfile:
    reader = csv.reader(myfile,  quoting=3)
    for val in reader:
        if(val[0] == '1' and val[2] == '1'):
            tpos = tpos + 1
...
fpos=0
fneg=0
with open("output1\\resultGANB2.csv") as myfile:
    reader = csv.reader(myfile,  quoting=3)
    for val in reader:
        if(val[0] == '1' and val[2] == '1'):
            tpos = tpos + 1
...
print "GaussianNBClassifier UNI........................................."
print(tpos)
print(tneg)
print(fpos)
print(fneg)
