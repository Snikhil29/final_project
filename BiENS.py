...
forest_output.to_csv( "output1\\resultF2.csv", index=False, quoting=3 )
...
GradientBoosting_output.to_csv( "output1\\resultGB2.csv", index=False, quoting=3 )
...
AdaBoost_output.to_csv( "output1\\resultAB2.csv", index=False, quoting=3 )
...
Bagging_output.to_csv( "output1\\resultBAG2.csv", index=False, quoting=3 )
...
ExtraTrees_output.to_csv( "output1\\resultET2.csv", index=False, quoting=3 )
"""