...
MNB_output.to_csv( "output1\\resultMNB2.csv", index=False, quoting=3 )
...
BernoulliNB_output.to_csv( "output1\\resultBNB2.csv", index=False, quoting=3 )
...
GaussianNB_output.to_csv( "output1\\resultGANB2.csv", index=False, quoting=3 )
