...
forest_output.to_csv( "output\\resultF1.csv", index=False, quoting=3 )
...
GradientBoosting_output.to_csv( "output\\resultGB1.csv", index=False, quoting=3 )
...
AdaBoost_output.to_csv( "output\\resultAB1.csv", index=False, quoting=3 )
...
Bagging_output.to_csv( "output\\resultBAG1.csv", index=False, quoting=3 )
...
ExtraTrees_output.to_csv( "output\\resultET1.csv", index=False, quoting=3 )
