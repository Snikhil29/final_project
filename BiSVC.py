...
LinearSVC_output.to_csv("output1\\resultLSVC2.csv", index=False, quoting=3)
...
SVC_output.to_csv("output1\\resultSVC2.csv", index=False, quoting=3)
...
NuSVC_output.to_csv("output1\\resultNuSVC2.csv", index=False, quoting=3)
