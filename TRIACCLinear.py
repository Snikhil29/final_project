...
with open("output1\\resultSGDC3.csv") as myfile:
...
fpos=0
fneg=0
with open("output1\\resultLOR3.csv") as myfile:
    reader = csv.reader(myfile,  quoting=3)
    for val in reader:
        if(val[0] == '1' and val[2] == '1'):
            tpos = tpos + 1
...
fpos = 0
fneg = 0
with open("output1\\resultBR3.csv") as myfile:
    reader = csv.reader(myfile,  quoting=3)
    for val in reader:
        if(val[0] == '1' and val[2] == '1'):
            tpos = tpos + 1
