...
MNB_output.to_csv( "output1\\resultMNB3.csv", index=False, quoting=3 )
...
BernoulliNB_output.to_csv( "output1\\resultBNB3.csv", index=False, quoting=3 )
...
GaussianNB_output.to_csv( "output1\\resultGANB3.csv", index=False, quoting=3 )
