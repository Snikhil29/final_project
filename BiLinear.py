...
SGDClassifier_output.to_csv( "output1\\resultSGDC2.csv", index=False, quoting=3 )
...
LogisticRegression_output.to_csv( "output1\\resultLOR2.csv", index=False, quoting=3 )
...
BayesianRidge_output.to_csv( "output1\\resultBR2.csv", index=False, quoting=3 )
