...
SGDClassifier_output.to_csv( "output1\\resultSGDC3.csv", index=False, quoting=3 )
...
LogisticRegression_output.to_csv( "output1\\resultLOR3.csv", index=False, quoting=3 )
...
BayesianRidge_output.to_csv( "output1\\resultBR3.csv", index=False, quoting=3 )
