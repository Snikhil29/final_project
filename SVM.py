...
LinearSVC_output.to_csv("output\\resultLSVC1.csv", index=False, quoting=3)
...
SVC_output.to_csv("output\\resultSVC1.csv", index=False, quoting=3)
...
NuSVC_output.to_csv("output\\resultNuSVC1.csv", index=False, quoting=3)
